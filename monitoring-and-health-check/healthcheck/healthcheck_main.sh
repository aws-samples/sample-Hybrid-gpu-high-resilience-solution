...
mpirun --allow-run-as-root  --hostfile /healthcheck/my_hosts -x NCCL_DEBUG=INFO -x NCCL_SOCKET_IFNAME=enp -x NCCL_IB_DISABLE=0 -x NCCL_IB_HCA=mlx_aws_100 --mca plm_rsh_args "-p 2022"  --bind-to none --mca btl_openib_allow_ib 1 --mca btl_openib_if_include mlx_aws_100  --mca btl '^tcp' /workspace/nccl-tests/build/all_reduce_perf -b 8M -e 128M -f 2-g 1
...
touch /healthcheck/healthcheck/finish.txt
